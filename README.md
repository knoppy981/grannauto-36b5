...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create grannauto-36b5
  fly apps create grannauto-36b5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app grannauto-36b5
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app grannauto-36b5-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'grannauto-36b5-staging' does not match app name in config file 'grannauto-36b5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name grannauto-36b5-db
  fly postgres attach --postgres-app grannauto-36b5-db --app grannauto-36b5

  fly postgres create --name grannauto-36b5-staging-db
  fly postgres attach --postgres-app grannauto-36b5-staging-db --app grannauto-36b5-staging
  ```
